...
for i in range(10):#change of page range_jia
    ...
    end_link = '/div/div/div/div[1]/div/div[1]/div[3]/a[@target="_blank"]/@href'  
    #Alternative: end_link = '/div/div/div/div[2]/a[@target="_blank"]/@href'
