...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb  4 18:40:31 2020
...
import re
import time
from shopping_fsm import Shop_FSM
import os
print(os.getcwd())


with open('config_file_shop.yml') as file:
...
if db_in_flag == 'csv':
    ...
    '''poi_index = [1]
    poi_name=['Singapore Flyer']
    poi_url=['https://piao.ctrip.com/ticket/dest/t61017.html'] 
...
if __name__=="__main__":
    ...
    fsm = Shop_FSM(chromedriver_path, poi_df, cnx, db_out_flag)
