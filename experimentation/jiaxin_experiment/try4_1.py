...
poi_df = pd.DataFrame(columns=['POIs', 'ratings', 'address','opening hours','attributes_crawled time'])
...
poi_df.loc[poi_df.shape[0]] = [name]+[ratings]+[address]+[openhr]+[today_date]
