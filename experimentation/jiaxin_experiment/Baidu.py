...
class BaiduAPI:
    ...
    def sentiment(self):
        ...
        self.sentiment_df.to_csv('./experimentation/jiaxin_experiment/sentiment.csv',index=False)    
        #input Alidata
        comment_list=pd.read_excel('./experimentation/jiaxin_experiment/STB.xls')    
        df=pd.DataFrame({'index': comment_list['Index'],
                         'reviews':comment_list['Text']
                         })
        ...
        self.sentiment_df.to_csv('./experimentation/jiaxin_experiment/sentiment.csv',
                                                          mode='a', 
                                                          header=False,
                                                          index=False)
