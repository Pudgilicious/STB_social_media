...
from Ctrip_ch_crawler import CtripCrawler
...
class Ctrip_FSM:
    ...
    def start(self,proxy_mode=None,timeout=None,authen_count=None,earliest_date=None):
        """
        ...
        while crawler.fsm_state != "4_complete":
            crawler.crawl_pois(proxy_mode,timeout,authen_count,earliest_date)
