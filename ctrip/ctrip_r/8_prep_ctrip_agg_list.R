...
df2 = read_csv("./ctrip/ctrip_r/20200117_chinese_ctrip_list.csv")
df2$X1 = 1:nrow(df2)
df2 = df2 %>%
        rename(., id = X1) %>%
...
df2_1 = read_csv("./ctrip/ctrip_r/20200117_eng_ctrip_list.csv")
...
filename = paste0("ctrip/ctrip_r/",gsub("-","", Sys.Date()), "_TB_SOCIAL_CTRIP_CRAWL_LIST.csv")
