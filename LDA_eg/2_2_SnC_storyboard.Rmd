...
***
Note: This POC is to showcase the type of text analysis that we could do to support our studies. I genrally relied on this framework here (https://www.tidytextmining.com/) for the analysis

Before I started my analysis, I used textcat package to identify the text rows that're in English.

Here is an example of the 1st 2 rows in the dataset (only Strengths used here. I left out weakneess in the analysis). 



### Most common terms in data
...
We could see that the most common words are 'team', 'people', 'leadership', 'positive' - suggesting that people tend to have these attributes as their strengths
...
### Topic Modelling & Word-topic probabilities
...
### Top 10 terms that best represents each topic
